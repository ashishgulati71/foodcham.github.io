...
(function($) {
   ...
   $(window).on('load', function() {
      ...
      // intro section animation
       ...
       $(".carousel-control").css("background","none");
       $(".ss_desc").html($("#styles_caro ul:first-child figurecaption").html());
        carouselScreenShots();
  	});
   ...
   $(window).on('scroll', function() {
		...
		var y = $(window).scrollTop(),
		    ...
		    triggerHeight =$("#features").offset().top-siteLogo.innerHeight()-parseInt(siteLogo.css('top'));		
  ...
  /* ------------------------------------------------------
	...
	* ------------------------------------------------------ */
	...
	var mailChimpURL = 'https://foodcham.us14.list-manage.com/subscribe/post?u=07164b2950168a5c0b82399f9&amp;id=f12ecca371'
...
function carouselScreenShots(){
	...
	var li=$("#slides_caro ul li");
    var length=li.length;
    var currentLiIndex=0;
    $('#prev').click(function() {
        currentLiIndex--;
        if(currentLiIndex<0)currentLiIndex=length-1;
       anim(li,currentLiIndex);
        return false;    
	});
	...
	$('#next').click(function() {
		currentLiIndex++;
        if(currentLiIndex>length-1)currentLiIndex=0;
        anim(li,currentLiIndex);
        return false;
...
//         console.log(
        ...
        li[currentLiIndex].children[0].setAttribute('src',temp);
         $(".ss_desc").fadeTo("slow",0);
        $(".ss_desc").html($(li[currentLiIndex]).find('figcaption').html());
         $(".ss_desc").fadeTo("slow",1);
         $("#carousel .carousel-indicators .active").removeClass("active");
         $("#carousel .carousel-indicators li")[currentLiIndex].classList.add("active");
    }    
